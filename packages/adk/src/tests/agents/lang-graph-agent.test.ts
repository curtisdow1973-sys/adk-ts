...
import { LangGraphAgent, LangGraphNode } from "../../agents/lang-graph-agent";
...
function createMockContext(): InvocationContext {
    return {
      ...
      endInvocation: false,
      createChildContext: vi.fn(function (agent) {
...
describe("LangGraphAgent", () => {
    ...
    let agentA: MockAgent, agentB: MockAgent, agentC: MockAgent;
    let nodeA: LangGraphNode, nodeB: LangGraphNode, nodeC: LangGraphNode;
