...
program
	...
	.option('-t, --template <template>', 'Template to use (simple-agent, discord-bot, telegram-bot, hono-server, mcp-starter)', 'simple-agent')
...
program
	...
	.argument('[agent-path]', 'Path to the agent file (default: looks for agent.ts in current/agents directory)')
...
program
	...
	.option('-d, --dir <directory>', 'Directory to scan for agents (default: ./agents)', './agents')
