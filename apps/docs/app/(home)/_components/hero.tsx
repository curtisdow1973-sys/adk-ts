  ...
  return (
    <section className="relative flex flex-1 flex-col justify-center items-center px-2 sm:px-4 py-8 sm:py-12 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-background via-card to-muted/20">
        ...
        <div className="absolute top-8 left-8 w-24 sm:w-32 h-24 sm:h-32 bg-primary/10 rounded-full blur-2xl animate-ping opacity-20"></div>
        <div className="absolute bottom-8 right-8 w-32 sm:w-40 h-32 sm:h-40 bg-chart-1/10 rounded-full blur-2xl animate-ping opacity-20 animation-delay-2000"></div>
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3">
            ...
            <br />
            <span className="text-primary text-xl sm:text-2xl md:text-3xl lg:text-4xl font-medium">for TypeScript</span>
          </h1>
        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          ...
          <div className="relative w-full min-w-0 px-2 sm:px-0">
