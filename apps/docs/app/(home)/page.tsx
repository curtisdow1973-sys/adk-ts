...
export default function HomePage() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="flex flex-1 flex-col justify-center items-center text-center px-4 py-16 bg-gradient-to-br from-background via-card to-muted/20">
        <div className="max-w-6xl mx-auto space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg border border-border bg-background px-8 py-3 text-lg font-medium text-foreground transition-all hover:bg-accent hover:text-accent-foreground hover:scale-105"
            >
              Quick Start
            </Link>
          </div>
