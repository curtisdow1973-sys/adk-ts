...
ADK supports many models through Vercel AI SDK including OpenAI, Anthropic, Google, Mistral, and more. Check the [Models documentation](/docs/agents/models) for the complete list of supported providers.
</Callout>
