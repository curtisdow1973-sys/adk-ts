...
<Cards>
  ...
  <Card
    ...
    href="/docs/tools/mcp-tools"
  />

  <Card
    title="🌐 Third-Party Tools"
    description="Integrate tools from popular external libraries"
  ...
  <Card
    ...
    description="Tools for Google Cloud services and APIs"
...
1. **[Function Tools](/docs/tools/function-tools)** - Learn to create custom tools
2. **[Built-in Tools](/docs/tools/built-in-tools)** - Explore ready-to-use capabilities
3. **[Authentication](/docs/tools/authentication)** - Secure your tool integrations

## Advanced Topics

Once you're comfortable with the basics:

- **[OpenAPI Tools](/docs/tools/openapi-tools)** - Generate tools from API specifications
- **[Google Cloud Tools](/docs/tools/google-cloud-tools)** - Enterprise cloud integrations
- **[MCP Tools](/docs/tools/mcp-tools)** - Standardized tool protocols