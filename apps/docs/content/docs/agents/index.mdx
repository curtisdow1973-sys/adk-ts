...
1. **[LLM Agents](/docs/agents/llm-agents)** - Learn the most common agent type
2. **[Workflow Agents](/docs/agents/workflow-agents)** - Understand orchestration patterns
3. **[Models](/docs/agents/models)** - Configure LLM models and settings

## Advanced Topics

Once you're comfortable with the basics:

- **[Custom Agents](/docs/agents/custom-agents)** - Build specialized agent types
- **[Multi-Agent Systems](/docs/agents/multi-agents)** - Coordinate multiple agents