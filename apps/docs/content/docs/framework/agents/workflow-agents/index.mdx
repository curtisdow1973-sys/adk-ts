...
1. **[Sequential Agents](/docs/framework/agents/workflow-agents/sequential-agents)** - For step-by-step processes
2. **[Parallel Agents](/docs/framework/agents/workflow-agents/parallel-agents)** - For independent tasks
3. **[Loop Agents](/docs/framework/agents/workflow-agents/loop-agents)** - For iterative processes