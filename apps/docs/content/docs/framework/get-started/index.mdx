...
[→ About ADK TypeScript](/docs/framework/get-started/about)
...
<Cards>
  ...
  >
    Read **[About ADK TypeScript](/docs/framework/get-started/about)** to understand the architecture and design philosophy.
