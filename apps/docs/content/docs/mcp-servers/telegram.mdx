...
- An example telegram bot written with adk-ts that makes use of sampling: [Telegram bot example](https://github.com/IQAIcom/adk-ts/tree/main/apps/examples/src/mcp-telegram-agent/index.ts)
