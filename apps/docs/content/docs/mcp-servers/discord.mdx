...
- An example discord bot written with adk-ts that makes use of sampling: [Discord bot example](https://github.com/IQAIcom/adk-ts/tree/main/apps/examples/src/mcp-discord-agent/index.ts)
